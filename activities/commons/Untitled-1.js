...
module.exports = function(nsp) {
  ...
  try {
    ...
    defaultConfig = {
      ...
      enablePublicInvestment: false, // New: Controls if students can use public investment
  ...
  function startTurn() {
    ...
    // Example: $100 investment increases growthRate by 0.01 (1%), max +0.1
    const maintenanceBonusGrowth = Math.min(0.10, (totalMaintenanceInvestmentThisTurn / 100) * 0.01);
    effectiveGrowthRate += maintenanceBonusGrowth;
    ...
    // Example: $10 investment adds 1 fish
    const stockedFish = Math.floor(totalStockingInvestmentThisTurn / 10);
